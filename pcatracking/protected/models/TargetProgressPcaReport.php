...
class TargetProgressPcaReport extends CActiveRecord
{
    ...
    {
        return array('pca_report_target_progress_id');
        # code...
    }
	...
	public function rules()
	{
		...
		return array(
			array('pca_target_progress_id, pca_report_id', 'required'),
			array('pca_report_target_progress_id, pca_report_id, total', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('pca_report_id, total', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
            ...
            'PcaTargetProgress' => array(self::BELONGS_TO, 'PcaTargetProgress', array('pca_target_progress_id')),
...
//			'unit_id' => 'Unit',
	...
	public function search()
	{
		...
		$criteria->compare('pca_target_progress_id',$this->pca_target_progress_id);
