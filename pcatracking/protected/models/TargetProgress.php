...
//	}
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('target_progress_id, target_id, unit_id, total, current, shortfall', 'numerical' ,'integerOnly'=>true),
    ...
    {
        return array('target_progress_id');
        # code...
    }
    ...
    public function relations()
    {
        ...
        return array(
            'pcaTargetProgressRel' => array(self::HAS_MANY, 'PcaTargetProgress', 'tbl_pca_target_progress(target_progress_id)'),
            'targetChange' => array(self::HAS_MANY, 'TargetChange', 'tbl_target_change(target_progress_id)'),
